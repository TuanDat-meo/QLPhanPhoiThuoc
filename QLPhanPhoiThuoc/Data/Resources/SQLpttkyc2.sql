-- =====================================================
-- DỮ LIỆU MẪU CHO HỆ THỐNG TÍCH HỢP (ĐÃ TỐI ưU HÓA)
...
PRINT N'--- Bắt đầu insert dữ liệu VNeID ---';
...
-- Lưu ý: Người số 7 (Đỗ Văn Giang - 001087007890) và số 10 (Trần Ngọc Linh - 001118010123) không có thẻ BHYT
GO
...
PRINT N'✓ Hoàn thành insert dữ liệu VNeID Database';
PRINT N'';
...
-- Tầng 2: Chẩn đoán, Thẻ BHYT
DELETE FROM ChanDoan;
DELETE FROM TheBHYT;

-- Tầng 1: Bệnh nhân, Thuốc, Nhân viên, Nhà cung cấp, Khoa phòng, Kho
...
-- Tầng 0: Cấu hình hệ thống
DELETE FROM ThongBao;
DELETE FROM CauHinhHeThong;
DELETE FROM CauHinh_VietQR;
GO

PRINT N'--- Bắt đầu insert dữ liệu BenhVienX ---';
...
-- 3. Nhân viên (Đã bao gồm NV011 - Admin từ đầu)
INSERT INTO NhanVien (MaNhanVien, TenNhanVien, ChucVu, ChuyenKhoa, BangCap, MaKhoa, SoDienThoai, Email, CCCD, NgaySinh, GioiTinh, DiaChi, TrangThai, NgayVaoLam, NgayTao) VALUES
-- Bác sĩ
('NV001', N'BS. Nguyễn Văn An', N'Bác sĩ', N'Nội khoa', N'Bác sĩ đa khoa', 'K001', '0987654321', 'bs.nguyenvana@benhvienx.vn', '079085001111', '1985-05-10', N'Nam', N'Hà Nội', N'DangLamViec', GETDATE(), GETDATE()),
('NV002', N'BS. Trần Thị Bình', N'Bác sĩ', N'Sản phụ khoa', N'Bác sĩ chuyên khoa II', 'K002', '0987654322', 'bs.tranthib@benhvienx.vn', '079090002222', '1990-08-15', N'Nữ', N'Hải Phòng', N'DangLamViec', GETDATE(), GETDATE()),
('NV003', N'BS. Lê Văn Cường', N'Bác sĩ', N'Ngoại khoa', N'Bác sĩ chuyên khoa I', 'K003', '0987654323', 'bs.levanc@benhvienx.vn', '079078003333', '1978-12-20', N'Nam', N'Nghệ An', N'DangLamViec', GETDATE(), GETDATE()),
('NV004', N'BS. Phạm Thị Dung', N'Bác sĩ', N'Nhi khoa', N'Bác sĩ chuyên khoa I', 'K004', '0987654324', 'bs.phamthid@benhvienx.vn', '079095004444', '1995-03-25', N'Nữ', N'Nam Định', N'DangLamViec', GETDATE(), GETDATE()),
('NV005', N'BS. Hoàng Văn Em', N'Bác sĩ trưởng', N'Đa khoa', N'Bác sĩ chuyên khoa II', 'K005', '0987654325', 'bs.hoangvane@benhvienx.vn', '079088005555', '1988-07-30', N'Nam', N'Thái Bình', N'DangLamViec', GETDATE(), GETDATE()),
-- Dược sĩ
('NV006', N'DS. Vũ Thị Hương', N'Dược sĩ', N'Dược lâm sàng', N'Dược sĩ đại học', 'K005', '0987654326', 'ds.vuthihuong@benhvienx.vn', '079092006666', '1992-11-12', N'Nữ', N'Hà Nam', N'DangLamViec', GETDATE(), GETDATE()),
('NV007', N'DS. Đỗ Văn Phúc', N'Dược sĩ trưởng', N'Dược lâm sàng', N'Dược sĩ chuyên khoa I', 'K005', '0987654327', 'ds.dovanphuc@benhvienx.vn', '079087007777', '1987-09-18', N'Nam', N'Ninh Bình', N'DangLamViec', GETDATE(), GETDATE()),
-- Thu ngân
('NV008', N'Bùi Thị Lan', N'Thu ngân', N'Kế toán', N'Trung cấp kế toán', 'K005', '0987654328', 'tn.buithilan@benhvienx.vn', '079093008888', '1993-04-22', N'Nữ', N'Thanh Hóa', N'DangLamViec', GETDATE(), GETDATE()),
('NV009', N'Nguyễn Văn Minh', N'Thu ngân', N'Kế toán', N'Cao đẳng kế toán', 'K005', '0987654329', 'tn.nguyenvanminh@benhvienx.vn', '079091009999', '1991-06-05', N'Nam', N'Hà Nội', N'DangLamViec', GETDATE(), GETDATE()),
-- Nhân viên kho
('NV010', N'Trần Văn Sơn', N'Quản lý kho', N'Kho thuốc', N'Trung cấp dược', 'K001', '0987654330', 'kho.tranvanson@benhvienx.vn', '079089010000', '1989-02-14', N'Nam', N'Hải Phòng', N'DangLamViec', GETDATE(), GETDATE()),
-- Quản trị viên (NV011 - liên kết với tài khoản Admin)
('NV011', N'Quản trị viên Admin', N'Quản trị viên', N'Công nghệ thông tin', N'Thạc sĩ chuyên ngành', 'K001', '0912345678', 'admin@benhvienx.vn', '001090123456', '1990-01-01', N'Nam', N'Hà Nội', N'DangLamViec', GETDATE(), GETDATE());
GO
...
-- 7. Bệnh nhân (Liên kết với VNeID qua CCCD) - Đã bao gồm MaTaiKhoan cho BN001
INSERT INTO BenhNhan (MaBenhNhan, CCCD, TenBenhNhan, NgaySinh, GioiTinh, SoDienThoai, DiaChi, Email, NhomMau, NgheNghiep, TienSuDiUng, MaTaiKhoan, TrangThai, NgayTao) VALUES
-- Bệnh nhân nội trú (có BHYT 100%)
('BN001', '001085001234', N'Nguyễn Văn An', '1985-03-15', N'Nam', '0912345001', N'123 Đường Láng, Đống Đa, Hà Nội', 'nguyenvanan@email.com', N'O+', N'Kỹ sư', N'Không có tiền sử bệnh đặc biệt; Dị ứng: Không', 'TK_USER01', N'DangDieuTri', GETDATE()),
('BN002', '001090002345', N'Trần Thị Bình', '1990-07-22', N'Nữ', '0912345002', N'456 Lê Hồng Phong, Ngô Quyền, Hải Phòng', 'tranthib@email.com', N'A+', N'Giáo viên', N'Có tiền sử cao huyết áp; Dị ứng: Không', NULL, N'DangDieuTri', GETDATE()),
('BN003', '001078003456', N'Lê Văn Cường', '1978-11-30', N'Nam', '0912345003', N'789 Quang Trung, TP Vinh, Nghệ An', 'levanc@email.com', N'B+', N'Công nhân', N'Tiền sử viêm dạ dày; Dị ứng: Penicillin', NULL, N'DangDieuTri', GETDATE()),
-- Bệnh nhân ngoại trú (có BHYT 95%)
('BN004', '001095004567', N'Phạm Thị Dung', '1995-05-18', N'Nữ', '0912345004', N'321 Trần Hưng Đạo, TP Nam Định', 'phamthid@email.com', N'AB+', N'Sinh viên', N'Không có tiền sử bệnh đặc biệt; Dị ứng: Không', NULL, N'DaRaVien', GETDATE()),
('BN005', '001088005678', N'Hoàng Văn Em', '1988-09-25', N'Nam', '0912345005', N'654 Lý Thường Kiệt, TP Thái Bình', 'hoangvane@email.com', N'O-', N'Lái xe', N'Tiền sử hen suyễn; Dị ứng: Aspirin', NULL, N'DangDieuTri', GETDATE()),
('BN006', '001092006789', N'Vũ Thị Hoa', '1992-12-08', N'Nữ', '0912345006', N'987 Trần Phú, TP Phủ Lý, Hà Nam', 'vuthih@email.com', N'A-', N'Nội trợ', N'Tiền sử tiểu đường type 2; Dị ứng: Không', NULL, N'DangDieuTri', GETDATE()),
-- Bệnh nhân không có BHYT
('BN007', '001087007890', N'Đỗ Văn Giang', '1987-04-14', N'Nam', '0912345007', N'147 Lê Lợi, TP Ninh Bình', 'dovang@email.com', N'B+', N'Buôn bán', N'Không có tiền sử bệnh đặc biệt; Dị ứng: Không', NULL, N'DaRaVien', GETDATE()),
-- Bệnh nhân có BHYT hết hạn
('BN008', '001983008901', N'Bùi Thị Hồng', '1983-08-20', N'Nữ', '0912345008', N'258 Quang Trung, TP Thanh Hóa', 'buithih@email.com', N'O+', N'Hưu trí', N'Tiền sử đái tháo đường; Dị ứng: Không', NULL, N'DangDieuTri', GETDATE()),
-- Bệnh nhân trẻ em
('BN009', '001115009012', N'Nguyễn Minh Khang', '2015-02-28', N'Nam', '0912345009', N'369 Giải Phóng, Hoàng Mai, Hà Nội', 'phuhuynhkhang@email.com', N'A+', N'Học sinh', N'Trẻ em khỏe mạnh; Dị ứng: Không', NULL, N'DangDieuTri', GETDATE()),
('BN010', '001118010123', N'Trần Ngọc Linh', '2018-06-15', N'Nữ', '0912345010', N'741 Lạch Tray, Ngô Quyền, Hải Phòng', 'phuhuynhlinh@email.com', N'B+', N'Học sinh', N'Trẻ em bình thường; Dị ứng: Không', NULL, N'DangDieuTri', GETDATE());
GO
...
-- Lưu ý: BN007 và BN010 không có thẻ BHYT
GO
...
-- DT010: Tiêu chảy trẻ em (Không BHYT)
...
-- 14. Tài khoản (Password mặc định: 123456, Hash SHA256: jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=)
INSERT INTO TaiKhoan (MaTaiKhoan, MaNhanVien, Username, PasswordHash, Role, TrangThai, NgayTao) VALUES
-- Tài khoản Admin test
('TK_ADMIN', 'NV011', 'admin', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'Admin', N'HoatDong', GETDATE()),
-- Tài khoản User test (Bệnh nhân BN001)
('TK_USER01', NULL, 'user01', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'User', N'HoatDong', GETDATE()),
-- Tài khoản Bác sĩ (Role = Admin để có full quyền)
('TK001', 'NV001', 'bs.nguyenvana', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'Admin', N'HoatDong', GETDATE()),
('TK002', 'NV002', 'bs.tranthib', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'Admin', N'HoatDong', GETDATE()),
('TK003', 'NV003', 'bs.levanc', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'Admin', N'HoatDong', GETDATE()),
('TK004', 'NV004', 'bs.phamthid', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'Admin', N'HoatDong', GETDATE()),
('TK005', 'NV005', 'bs.hoangvane', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'Admin', N'HoatDong', GETDATE()),
-- Tài khoản Dược sĩ, Thu ngân, Kho (Role = NhanVien)
('TK006', 'NV006', 'ds.vuthihuong', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'NhanVien', N'HoatDong', GETDATE()),
('TK007', 'NV007', 'ds.dovanphuc', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'NhanVien', N'HoatDong', GETDATE()),
('TK008', 'NV008', 'tn.buithilan', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'NhanVien', N'HoatDong', GETDATE()),
('TK009', 'NV009', 'tn.nguyenvanminh', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'NhanVien', N'HoatDong', GETDATE()),
('TK010', 'NV010', 'kho.tranvanson', 'jZae727K08KaOmKSgOaGzww/XVqGr/PKEgIMkjrcbJI=', N'NhanVien', N'HoatDong', GETDATE());
GO

PRINT N'✓ Hoàn thành insert dữ liệu BenhVienX Database';
PRINT N'';
...
PRINT N'  ✓ 11 Nhân viên (5 BS, 2 DS, 2 TN, 1 Kho, 1 Admin)';
...
PRINT N'  ✓ 12 Tài khoản (1 Admin, 1 User, 5 Bác sĩ, 5 Nhân viên)';
PRINT N'';
PRINT N'LIÊN KẾT DỮ LIỆU:';
PRINT N'  ✓ Số CCCD: VNeID.CongDan = BenhVienX.BenhNhan.CCCD';
PRINT N'  ✓ Số thẻ BHYT: VNeID.TheBHYT_Mock = BenhVienX.TheBHYT.SoTheBHYT';
PRINT N'  ✓ BenhVienX có thể tra cứu thông tin công dân từ VNeID';
PRINT N'  ✓ BenhVienX có thể kiểm tra thẻ BHYT từ VNeID';
PRINT N'';
PRINT N'TÀI KHOẢN TEST (Password: 123456):';
PRINT N'  ✓ Admin: admin / 123456 (Role: Admin, NV011)';
PRINT N'  ✓ User: user01 / 123456 (Role: User, BN001)';
PRINT N'  ✓ Bác sĩ: bs.nguyenvana / 123456 (Role: Admin)';
PRINT N'  ✓ Dược sĩ: ds.vuthihuong / 123456 (Role: NhanVien)';
PRINT N'  ✓ Thu ngân: tn.buithilan / 123456 (Role: NhanVien)';
PRINT N'';
...
PRINT N'  - BN007: Ngoại trú, KHÔNG có BHYT';
...
PRINT N'';
PRINT N'=================================================================';
PRINT N'✅ HOÀN TẤT INSERT DỮ LIỆU MẪU';
PRINT N'=================================================================';
GO
